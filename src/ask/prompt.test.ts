...
const cands: Candidate[] = [
  { messageId: 101, chat: "גיבוש", sender: "יוסי", sentAt: new Date("2026-06-09T09:10:00Z"), content: "ערב יום שני אצלי ב-20:00", score: 1 },
  { messageId: 102, chat: "משפחה", sender: "אמא", sentAt: new Date("2026-06-07T12:00:00Z"), content: "אל תשכח חלב", score: 0.5 },
];
