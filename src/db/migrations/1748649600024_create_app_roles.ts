 ...
 *
 * - catchup_app:      LOGIN, NOSUPERUSER, NOBYPASSRLS — the app runtime connects as this.
 * - catchup_operator: LOGIN, NOSUPERUSER, BYPASSRLS   — cross-tenant admin (T5); unused in T1 runtime.
 *
 ...
 */
export const APP_ROLE = "catchup_app";
export const APP_ROLE_PASSWORD = "catchup_app_local_pw";
export const OPERATOR_ROLE = "catchup_operator";
export const OPERATOR_ROLE_PASSWORD = "catchup_operator_local_pw";
